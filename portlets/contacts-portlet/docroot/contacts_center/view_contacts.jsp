...
<aui:layout>
	<aui:column columnWidth="<%= 75 %>" cssClass="lfr-asset-column lfr-asset-column-details" first="<%= true %>">
		<c:choose>
			...
			<c:otherwise>
				<liferay-ui:panel-container extended="<%= false %>" id="viewContactsPanelContainer" persistState="<%= true %>">
					...
					<c:if test="<%= friendUsersCount > 0 %>">
						<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="viewContactsFriendsPanel" persistState="<%= true %>" title="friends">
					...
					<c:if test="<%= coworkerUsersCount > 0 %>">
						<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="viewContactsCoworkersPanel" persistState="<%= true %>" title="coworkers">
					...
					<c:if test="<%= followingUsersCount > 0 %>">
						<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>"  id="viewContactsFollowingPanel" persistState="<%= true %>" title="following">
