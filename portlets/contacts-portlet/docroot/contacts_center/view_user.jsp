...
<aui:layout>
	<aui:column columnWidth="<%= 75 %>" cssClass="lfr-asset-column lfr-asset-column-details" first="<%= true %>">
		...
		<liferay-ui:panel-container extended="<%= false %>" id="viewUserPanelContainer" persistState="<%= true %>">
			<c:if test="<%= showUsersInformation && UserPermissionUtil.contains(permissionChecker, user2.getUserId(), ActionKeys.VIEW) %>">
				<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="viewUserInformationPanel" persistState="<%= true %>" title="information">
				...
				%>
					...
					<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id='<%= "viewUser" + title + "Panel" %>' persistState="<%= true %>" title="<%= title %>">
						<div class="<%= cssClass %>">
			...
			<c:if test="<%= showUsersRecentActivity %>">
				<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="viewUserRecentActivityPanel" persistState="<%= true %>" title="recent-activity">
